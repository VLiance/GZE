...
#define GZ_mNewThreadH() \
    ...
    gzSp<Lib_GZ::cThreadExt> NewThread(Lib_GZ::cClass* _parent); \
...
gzSp<Lib_GZ::cThreadExt> _sLib::_sClass::NewThread(Lib_GZ::cClass* _parent){   \
...
#define GZ_mEndStaticClassOp(_Class, _Op)\
	public:\
		inline cs##_Class(Lib_GZ::cClass* _parent): Op(_parent){};\
		inline ~cs##_Class(){};\
};\
