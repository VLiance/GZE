...
package  { 
	...
	public class Math  {
		...
		static changeRem GZ_M_fFrac function fFrac(_nVal:Float):Float;	
		static changeRem GZ_M_fIFrac function fIFrac(_nVal:Int):Int;	
		static changeRem GZ_M_fITronc function fITronc(_nVal:Int):Int;	
		static changeRem GZ_M_fIPixFrac function fIPixFrac(_nVal:Int):Int;	
		//static changeRem GZ_ToPix function fIToPix(_nVal:Int):Int;	
			
		//static changeRem GZ_M_fAbs function fAbs(_nVal:Float):Float;
		//static changeRem GZ_M_fAbs function fIAbs(_nVal:Int):Int;
			
		static changeRem GZ_M_fMin function fMin(_nVal1:Int, _nVal2:Int):Int;
		static changeRem GZ_M_fMax function fMax(_nVal1:Int, _nVal2:Int):Int;
		/*
		...
		*/
		static changeRem GZ_M_fSqrt function fSqrt(_nVal:Float):Float;
		static changeRem GZ_M_fPow  function fPow(_nVal:Float, _nPower:Float):Float;
		static changeRem GZ_M_fPow2  function fPow2(_nVal:Float, _nPower:Float):Float;
		static changeRem GZ_M_fToRadian  function fToRadian(_nDegree:Float):Float;
