...
namespace Lib_GZ{
	...
	*/
	...
	class cHoldGate{
		...
		Lib_GZ::cThreadMsg*  fReceive(Lib_GZ::cClass* _oReceivingClass);
...
public :
	...
	inline gzSp<T> fReceive(Lib_GZ::cClass* _oReceivingClass){ return gzSp<T>((T*)oHold->fReceive(_oReceivingClass)); }
