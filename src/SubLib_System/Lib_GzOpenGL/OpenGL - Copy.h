...
#include "Lib_GZ_Platform/EmscHeader.h"
#endif
...
class tApi_Lib_GZ_OpenGL cOpenGL : public Lib_GZ::Base::cClass {
...
class tApi_Lib_GZ_OpenGL csOpenGL : public Lib_GZ::cStThread  {
	...
	//	gzVal oGL = val::global("Null");
		...
		inline csOpenGL(Lib_GZ::Base::cClass* _parent): Lib_GZ::cStThread(_parent){};
		inline ~csOpenGL(){};
};
...
#if !( defined D_Platform_Web_Emsc ||  defined GZ_tCpcDos  ||  defined GZ_tLite  ) 
