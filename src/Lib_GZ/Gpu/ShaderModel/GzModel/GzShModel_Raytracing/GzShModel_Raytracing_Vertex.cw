package  { 
	...
	import GZ.Gpu.ShaderModel.GzModel.GzShModel_Raytracing.GzShModel_Raytracing_Fragment;
	...
	public extension GzShModel_Raytracing_Vertex extends GzShModel_Raytracing_Fragment {
