package  { 
	...
	import GZ.Gpu.ShaderModel.GzModel.GzShModel_Shadertoy.GzShModel_Shadertoy_Fragment;
	...
	public extension GzShModel_Shadertoy_Vertex extends GzShModel_Shadertoy_Fragment {
