...
#define GZ_M_fITronc(IVal) (((IVal) >> Lib_GZ::Base::Math::Math::nIPrecision) << Lib_GZ::Base::Math::Math::nIPrecision)
...
#define GZ_tDONT_USE_MATH_ABS
	...
	#ifdef GZ_tLibRT
		#define abs Lib_GZ::Base::Math::pMath::fAbs //Remap normal abs //TODO
	#endif
